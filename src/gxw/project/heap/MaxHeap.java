...
/**
 * @author golden Heap is a complete BTree
 * @param <E>
 */
public class MaxHeap<E>
{
    ...
    // create a heap by an array using heapify
    ...
    public void add(E obj)
    {
        ...
        System.out.println(String.format("Inserted %s. %s", obj, this));
    }
    ...
    private void trickleDown(int pos)
    {
        ...
        {
            // return if the left child hits the heap size. Swap the value if
            // the left child is greater than its parent
            if (((Comparable) this.array[leftChildPos]).compareTo(array[pos]) > 0)
                swap(pos, leftChildPos);
            return;
        }

        // compare values between left and right child to do the next trickle
        // down action
    ...
    public static void main(String[] args)
    {
        ...
        heap.add(7);
        heap.printArray();
        heap = new MaxHeap<Integer>(new Integer[]{1,2,3,4,5,6,7});
        heap.printArray();
    }
}
